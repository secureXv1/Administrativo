    ...
    <div class="sticky top-0 z-10 bg-white/70 backdrop-blur border-b border-slate-200">
      <div class="max-w-9xl mx-auto px-4 py-3 flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="font-semibold text-slate-900">{{ isGroupMode ? 'Detalle de reporte del grupo' : 'Detalle de reporte de unidad' }}</h2>
            <p class="text-slate-500 text-xs">Detalle de las novedades del personal</p>
          </div>
        </div>
...
const needsFechas      = computed(() => [
  ...
  'LICENCIA PATERNIDAD','PERMISO','DESCANSO ESPECIAL','PERMISO ACTIVIDAD PERSONAL', 'COMISIÓN EN EL EXTERIOR',
...
function iconFor(state){
  ...
  const map = {
    ...
    'EXCUSA DEL SERVICIO':'📝','LICENCIA PATERNIDAD':'🍼','PERMISO':'⏳', 'DESCANSO ESPECIAL':'🎆',
 'PERMISO ACTIVIDAD PERSONAL':'⏳',
